...
| IndexedDB `pi-chrome-sessions` | Versioned complete messages, model state, names, timestamps, embedded screenshot and pasted-image content | Until retention deletion or user clear |
