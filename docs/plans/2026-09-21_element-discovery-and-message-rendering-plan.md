...
- Blocked: stable Chrome Side Panel manual acceptance (`docs/manual-acceptance.md`, cases 14–15). No stable Chrome executable is installed. Do not check the manual task, mark the plan complete, or delete this file until a human records those results. Delivery will remain a draft PR until that evidence is supplied.
